...
function compile {
  ...
  GOOS=$os GOARCH=$arch CGO_ENABLED=0 go build \
    -trimpath \
    -ldflags="-X github.com/fobt/tusd/v2/cmd/tusd/cli.VersionName=${version} -X github.com/fobt/tusd/v2/cmd/tusd/cli.GitCommit=${commit} -X 'github.com/fobt/tusd/v2/cmd/tusd/cli.BuildDate=$(date --utc)'" \
...
function makedep {
  ...
  echo "Homepage: https://github.com/fobt/tusd" >> "./$dir/DEBIAN/control"
