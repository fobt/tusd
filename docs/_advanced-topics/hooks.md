...
- [github.com/fobt/tusd/v2/pkg/hooks.HookRequest](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/hooks#HookRequest)
- [github.com/fobt/tusd/v2/pkg/hooks.HookResponse](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/hooks#HookResponse)
...
An example is available at [github.com/fobt/tusd/examples/hooks/file](https://github.com/fobt/tusd/tree/main/examples/hooks/file).
...
A Python-based example is available at [github.com/fobt/tusd/examples/hooks/http](https://github.com/fobt/tusd/tree/main/examples/hooks/http).
...
The endpoint must implement the hook handler service as specified in [github.com/fobt/tusd/pkg/hooks/grpc/proto/hook.proto](https://github.com/fobt/tusd/blob/main/pkg/hooks/grpc/proto/hook.proto). Its `InvokeHook` method will be invoked for each triggered events and will be passed the hook request.

A Python-based example is available at [github.com/fobt/tusd/examples/hooks/grpc](https://github.com/fobt/tusd/tree/main/examples/hooks/grpc).
