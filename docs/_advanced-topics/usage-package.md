...
import (
	...
	"github.com/fobt/tusd/v2/pkg/filelocker"
	"github.com/fobt/tusd/v2/pkg/filestore"
	tusd "github.com/fobt/tusd/v2/pkg/handler"
)
...
Please consult the [online documentation](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg) for more details about tusd's APIs and its sub-packages.
...
If you have different requirements, you can build your own storage backend which will save the files to a remote FTP server or similar. Doing so is as simple as implementing the [`handler.DataStore`](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/handler#DataStore) interface and using the new struct in the [configuration object](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/handler#Config). Please consult the documentation about detailed information about the required methods.
...
* [**s3store**](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/s3store): A storage backend using AWS S3
* [**filestore**](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/filestore): A storage backend using the local file system
* [**gcsstore**](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/gcsstore): A storage backend using Google cloud storage
* [**memorylocker**](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/memorylocker): An in-memory locker for handling concurrent uploads
* [**filelocker**](https://pkg.go.dev/github.com/fobt/tusd/v2/pkg/filelocker): A disk-based locker for handling concurrent uploads
...
* [**tusd-etcd3-locker**](https://github.com/fobt/tusd-etcd3-locker): A locker using the distributed KV etcd3 store
...
Additional information can be found in the issues [#1100](https://github.com/fobt/tusd/issues/1100) and [#1107](https://github.com/fobt/tusd/issues/1107).
