...
Another option is to use a distributed lock using Redis, [etcd](https://github.com/fobt/tusd-etcd3-locker), and similar tools. As of right now, tusd does not yet offer distributed locks, but we are planning to support them in the near future.
